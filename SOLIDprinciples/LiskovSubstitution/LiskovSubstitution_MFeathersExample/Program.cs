...
{
    /// <summary>
    /// An example of Liskov Substitution Violation from Michael Feathers, from his 
    /// book "Working Effectively with Legacy Code", pg. 101-102.
    /// </summary>
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            r.SetHeight(3);
            r.SetWidth(4);
            // So, not really a *square* after all...? Liskov Substitution violation.
            ...
            // This is a classic example of a LSP violation. Objects of subclasses should be substitutable for objects of their super-classes throughout our code.

...
namespace OpenClosed_StrategyPattern.PressureSensorImplementations
{
    public sealed class ExternalTankPressureSensor : AbstractTankPressureSensor
    {
        ...
        public ExternalTankPressureSensor(TankOutletSizeCalculatorEnum tankOutletSizeCalculatorEnum, int tankCapacity = 3, int tankDiameter = 10) : base(tankOutletSizeCalculatorEnum, tankCapacity, tankDiameter)
        {
        }
